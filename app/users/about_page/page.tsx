      ...
      <footer className="bg-gray-800 text-white py-12 px-4">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">
              MedBooker is revolutionizing healthcare access and management,
              making it easier for patients to connect with healthcare providers
              and manage their health journey.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <MailIcon className="h-4 w-4 mr-2" /> info@medbooker.com
              </li>
              <li className="flex items-center">
                <PhoneIcon className="h-4 w-4 mr-2" /> +1 (555) 123-4567
              </li>
              <li className="flex items-center">
                <MapPinIcon className="h-4 w-4 mr-2" /> 123 Health St, Medical
                City, MC 12345
              </li>
            </ul>
          </div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-white hover:text-blue-400">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm4.995 16.979H7.005v-9.97h9.99v9.97zM9.503 7.009H7.005v2.498h2.498V7.009zm0 4.995H7.005v2.498h2.498v-2.498zm4.995-4.995h-2.498v2.498h2.498V7.009zm0 4.995h-2.498v2.498h2.498v-2.498z" />
                </svg>
              </a>
            </div>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} MedBooker. All rights reserved.
          </p>
        </div>
      </footer>
